  ...
  articles: [
    ...
    },
    {
      ...
      posts: [
        ...
        {
          header: "Feed efficiency comes into focus",
          text: `You begin with a text, you sculpt information, you chisel away what’s not needed, you come to the point, make things clear, add value, you’re a content person, you like words. <span className="text-second-bg">Design is no afterthought</span>, far from it, but it comes in a deserved second. Anyway, you still use Lorem Ipsum and rightly so, as it will always have a place in the web workers toolbox, as things happen, not always the way you like it, not always in the preferred order. <span className="italic">Even if your less into design and more into content strategy you may find some redeeming value with, wait for it, dummy copy, no less.</span>`,
          image: "/farm-single-post-image-1.jpg",
          reversed: true,
        },
        {
